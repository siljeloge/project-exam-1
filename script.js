...
function renderProducts(products) {
    ...
    const buttons = container.querySelectorAll(".view-product-btn");
...
// Render the latest 3 products into the carousel
function renderCarousel(products) {
    if (!carouselTrack) return;

    const latest = products.slice(-3); // get last 3 products
